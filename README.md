...
• La clase _Cuenta_ representa una cuenta bancaria, la cual posee un saldo en pesos de la cuenta y responde a los siguientes mensajes:
  o _Saldo:_ obtiene el saldo actual de la cuenta.
  o _AcreditarSaldo:_ suma a la cuenta el saldo indicado.
  o _DebitarSaldo:_ debita el saldo indicado de la cuenta, siempre y cuando se cuente con saldo suficiente en cuyo caso devuelve true. Si el saldo de la cuenta no es suficiente entonces el saldo no es debitado y devuelve false.
